 ...
 */
public class TelaPosBatalha5 extends javax.swing.JFrame {

    /**
     * Creates new form TelaPosBatalha5
     */
    public TelaPosBatalha5() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaPosBatalha5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaPosBatalha5().setVisible(true);
            }
        });
    }
