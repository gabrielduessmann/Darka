 ...
 */
public class TelaHistoria14 extends javax.swing.JFrame {

    /**
     * Creates new form TelaHistoria14
     */
    public TelaHistoria14() {
        initComponents();
        PerfilUsuario.checkpoint = 14;
        ...
        if (ArmazenaCadastroPersonagem.sexo.equals("Masculino")) {
            txtHistoria.setText("<html>Quando "+ArmazenaCadastroPersonagem.nome+" está indo o abraçar. Meskim puxa sua espada da bainha e mata Zabba. <br>Com isso, "+ArmazenaCadastroPersonagem.nome+" fica super irritado e vai para cima de Meskim.</html>");
        } else {
            txtHistoria.setText("<html>Quando "+ArmazenaCadastroPersonagem.nome+" está indo o abraçar. Meskim puxa sua espada da bainha e mata Zabba. <br>Com isso, "+ArmazenaCadastroPersonagem.nome+" fica super irritada e vai para cima de Meskim.</html>");
        }
    ...
    private void initComponents() {
        ...
        getContentPane().add(botao1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 550, 210, -1));
    ...
    private void botao1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botao1ActionPerformed
        ...
        TelaBatalha5 telaBatalha5 = new TelaBatalha5();
        telaBatalha5.setExtendedState(JFrame.MAXIMIZED_BOTH);
        dispose();
        telaBatalha5.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaHistoria14.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaHistoria14().setVisible(true);
            }
        });
    }
