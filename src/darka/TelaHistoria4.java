 ...
 */
public class TelaHistoria4 extends javax.swing.JFrame {

    /**
     * Creates new form TelaHistoria4
     */
    public TelaHistoria4() {
        initComponents();
        PerfilUsuario.checkpoint = 4;
        ...
        if (ArmazenaCadastroPersonagem.sexo.equals("Masculino")) {
            txtHistoria.setText("<html>Após um longo tempo de caminhada começa a escurecer, então Meskim sugere para que durmam e continuem ao amanhecer.</html>");
        } else {
            txtHistoria.setText("<html>Após um longo tempo de caminhada começa a escurecer, então Meskim sugere para que durmam e continuem ao amanhecer.</html>");    
        }
    ...
    private void initComponents() {
        ...
        getContentPane().add(botao1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 510, 220, -1));
        ...
        getContentPane().add(botao2, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 560, 220, -1));

        txtHistoria.setFont(new java.awt.Font("Arial", 0, 24)); // NOI18N
        txtHistoria.setForeground(new java.awt.Color(255, 255, 255));
        getContentPane().add(txtHistoria, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 120, 1050, 110));
        ...
        getContentPane().add(btnInventario, new org.netbeans.lib.awtextra.AbsoluteConstraints(1040, 450, 180, 180));
    ...
    private void botao2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botao2ActionPerformed
        ...
        int opcao = JOptionPane.showOptionDialog(null, ArmazenaCadastroPersonagem.nome+" e Meskim continuam a jornada, a noite"
                + " no meio da floresta encontram um monstro, \nmas como ambos estão muito cançado e despreparados sem "
                + "equipamentos, o inimigo os mata. ", "Morte", 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaHistoria4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaHistoria4().setVisible(true);
            }
        });
    }
