 ...
 */
public class TelaBatalha3 extends javax.swing.JFrame {

    /**
     * Creates new form TelaBatalha3
     */
    public TelaBatalha3() {
        initComponents();
        /*LUTA BOSS DEFESA*/
        ...
        if (ArmazenaCadastroPersonagem.sexo.equals("Masculino")){
            img.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/defense boss fight male.png")));
        } else {
            img.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/defense boss fight female.png")));
        }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 620, 250, -1));
        ...
        txtVidaInimigo.setText("15000");
        getContentPane().add(txtVidaInimigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(990, 0, -1, -1));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 570, 250, -1));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 620, 250, -1));
        ...
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 570, 250, -1));

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/potion3.png"))); // NOI18N
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 100, -1, -1));

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/bomb3.png"))); // NOI18N
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 20, -1, -1));

        img.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/defense boss fight male.png"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if ( PerfilUsuario.qtdeBomba != 0) {
            ...
            txtVidaPersonagem.setText(Integer.toString(PerfilUsuario.vida));
            txtVidaInimigo.setText(Integer.toString(PerfilInimigos.vidaBossDefesa));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        int danoInimigo = 549;
        do {
            danoPersonagem = gerador.nextInt(10); 
        } while (danoPersonagem < 5);

        
        PerfilUsuario.vida -= danoInimigo;
        PerfilInimigos.vidaBossDefesa -= danoPersonagem;
        txtVidaPersonagem.setText(Integer.toString(PerfilUsuario.vida));
        txtVidaInimigo.setText(Integer.toString(PerfilInimigos.vidaBossDefesa));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        txtDanoInimigo.setVisible(false);
        PerfilInimigos.contDefesas ++;
        txtDanoPersonagem.setText("Ataque defendido "+PerfilInimigos.contDefesas+"x");
        if (PerfilInimigos.contDefesas  == 3) {
            
            PerfilUsuario.vida = 550;
            PerfilUsuario.defesa += 80;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBatalha3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaBatalha3().setVisible(true);
            }
        });
    }
