 ...
 */
public class TelaHistoria9 extends javax.swing.JFrame {

    /**
     * Creates new form TelaHistoria9
     */
    public TelaHistoria9() {
        initComponents();
        PerfilUsuario.checkpoint = 9;
        txtHistoria.setText("<html>Após o confronto, "+ArmazenaCadastroPersonagem.nome+" e Meskim começam a conversar.<br> "
                + "</html>Muito dialogo depois, Meskim pede para você contar sua história de vida e saber um pouco mais sobre você.");
    ...
    private void initComponents() {
        ...
        botao1.setText("Contar sua história");
        ...
        getContentPane().add(botao1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 550, 260, -1));

        txtHistoria.setFont(new java.awt.Font("Arial", 0, 24)); // NOI18N
        txtHistoria.setForeground(new java.awt.Color(255, 255, 255));
        getContentPane().add(txtHistoria, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 120, 1050, 50));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaHistoria9.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaHistoria9().setVisible(true);
            }
        });
    }
